...
catch_by_groupisis_path2 <- paste0(here(),'/LHS_run/InputsMACCO')
...
for(i in seq(length(years))){
  ...
  saveRDS(Dat_kg,
          file = paste0(catch_by_groupisis_path2,
                        "/obs_catchKg_megrim_groupisis",
                        thisYear,
                        ".rds"))
}
```
...
for(i in seq(length(years))){
  ...
  if(nrow(thisYear)==1){
    ...
    saveRDS(Dat_kg,
          file = paste0(catch_by_groupisis_path2,
                        "/obs_catchKg_monkfish_groupisis",
                        thisYear,
                        ".rds"))
  }
...
for(i in seq(length(years))){
  ...
  if(nrow(thisYear)==1){
    ...
    saveRDS(Dat_kg,
          file = paste0(catch_by_groupisis_path2,
                        "/obs_catchKg_nephrops_groupisis",
                        thisYear,
                        ".rds"))
