---
title: "ISIS-Fish MACCO - Model calibration step 2b"
...
This document contains the code along with the results of the skill assessment of step 2b model. Simulations are run one year by one year, starting in 2015, 2016, 2017 and 2018, with forced recruitment. This script is also part of the calibration process given that it computes coefficients to perform seasonalisation of accessibility.   


This document is divided into three sections (each one in a different tab). The reader mainly interested by the results will find them in the second ection "Analysis by species". 
...
```{r}
sim_2015_path <- paste0(here(),"/Sim_data/raw/step2b_TF1q1/sim_calib_mod2b_2015_2025-07-18-22-21")
sim_2016_path <- paste0(here(),"/Sim_data/raw/step2b_TF1q1/sim_calib_mod2b_2016_2025-07-18-22-23")
sim_2017_path <- paste0(here(),"/Sim_data/raw/step2b_TF1q1/sim_calib_mod2b_2017_2025-07-18-22-26")
sim_2018_path <- paste0(here(),"/Sim_data/raw/step2b_TF1q1/sim_calib_mod2b_2018_2025-07-18-22-29")

```

The path to tidy simulation data:
```{r}
sim_tidy_path <- paste0(here(),"/Sim_data/tidy/step2b_TF1q1_metier/byyear_2015_2018")
```
...
Wether or not exporting seasonnal accessibility corrections (analysis by season), and  in that case, the path to previous accessibility file as well as the path to exported accessibility file:
```{r}
export_corrections_q <- T
previous_q_path <- paste0(here(),"/accessibility_values/q1_LHS_ouputs")
exported_q_path <- paste0(here(),"/accessibility_values/q2_season_step3b")
```
...
Let us gather season accessibility values and save it:
```{r,message=FALSE}
