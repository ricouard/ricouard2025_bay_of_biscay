---
title: "ISIS-Fish MACCO - Model calibration step 3a"
...
This document contains the code along with the results of the skill assessment of step 3a model. Simulations are run one year by one year, starting in 2015, 2016, 2017 and 2018, with forced recruitment. 
...
The first section is for the advanced user wanting to reproduce the analysis or to check the whole process. This user will need the source code (.Rmd file), the companion script **model_validation_fun.R** as well as observed and simulated data in the right format.

In the first section, "Preparation", he will find all the settings and preliminary steps required to perform the analysis, including loading of the companion script and packages, path specifications and control of data importation.
...
```{r}
sim_2015_path <- paste0(here(),"/Sim_data/raw/step3a_TF1q2/sim_assess_byyear_mod3a_2015_2025-07-23-19-02")
sim_2016_path <- paste0(here(),"/Sim_data/raw/step3a_TF1q2/sim_assess_byyear_mod3a_2016_2025-07-23-19-04")
sim_2017_path <- paste0(here(),"/Sim_data/raw/step3a_TF1q2/sim_assess_byyear_mod3a_2017_2025-07-23-19-06")
sim_2018_path <- paste0(here(),"/Sim_data/raw/step3a_TF1q2/sim_assess_byyear_mod3a_2018_2025-07-23-19-10")

```

The path to tidy simulation data:
```{r}
sim_tidy_path <- paste0(here(),"/Sim_data/tidy/step3a_TF1q2_all/byyear_2015_2018")
```
