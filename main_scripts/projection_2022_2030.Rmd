...
This document is divided into two sections (each one in a different tab). The reader mainly interested by the results will find them in the second section "Analysis by species". 
...
The analysis by fleet is not displayed here but the information can be extracted from the "tidy" simulation files.
