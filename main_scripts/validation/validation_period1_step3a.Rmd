---
title: "ISIS-Fish MACCO - Validation mod3a, 2015-2018, forced recruitment"
...
This document contains the code along with the results of the skill assessment of step 3a model over the period 2015-2018. The simulations are run for four years, starting in 2015, with forced recruitment.
...
```{r}
sim_path <- paste0(here(),"/Sim_data/raw/step3a_TF1q2/sim_valid_mod3a_2015_2018_2025-07-23-18-55")
```

The path to tidy simulation data:
```{r}
sim_tidy_path <- paste0(here(),"/Sim_data/tidy/step3a_TF1q2_all/seq_2015_2018")
```

Wether or not to save comparison datasets (obs vs. sim) and the path where to do it:
```{r}
do_I_save_comp <- T
comp_path <- paste0(here(),"/Comparison_data/step3a_TF1q2_all/seq_2015_2018")
```
