...
After a preparation consisting in loading and preparing data, the document is organised in 3 main tabs, one for analysis by fleets and one for the analysis by species. Inside these tabs, the reader will find skill assessment for the different versions of the model, measured by different metrics.
...
```{r}
fleet_weight_data <- fleet_weight(fleet_group_list = c("foreign","inf12","sup12"),
                                  path = obs_data_path,
