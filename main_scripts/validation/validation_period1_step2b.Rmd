---
title: "ISIS-Fish MACCO - Validation mod 2b, 2015-2018, forced recruitment"
...
This document contains the code along with the results of the skill assessment of step 2b model over the period 2015-2018. The simulations are run for four years, starting in 2015, with forced recruitment.
...
```{r}
sim_path <- paste0(here(),"/Sim_data/raw/step2b_TF1q1/sim_valid_mod2b_2015_2018_2025-07-18-22-12")
```

The path to tidy simulation data:
```{r}
sim_tidy_path <- paste0(here(),"/Sim_data/tidy/step2b_TF1q1_metier/seq_2015_2018")
```

Wether or not to save comparison datasets (obs vs. sim) and the path where to do it:
```{r}
do_I_save_comp <- T
comp_path <- paste0(here(),"/Comparison_data/step2b_TF1q1_metier/seq_2015_2018")
```
