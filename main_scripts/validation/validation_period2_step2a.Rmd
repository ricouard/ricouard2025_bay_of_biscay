---
title: "ISIS-Fish MACCO - Validation mod 2a, 2019-2022, forced recruitment"
...
This document contains the code along with the results of the skill assessment of step 2a model over the period 2019-2022. The simulations are run for four years, starting in 2019, with forced recruitment.
...
```{r}
sim_path <- paste0(here(),"/Sim_data/raw/step2a_TF0q2/sim_valid_mod2a_2019_2022_2025-07-17-00-55")
```

The path to tidy simulation data:
```{r}
sim_tidy_path <- paste0(here(),"/Sim_data/tidy/step2a_TF0q2_season/seq_2019_2022")
```

Wether or not to save comparison datasets (obs vs. sim) and the path where to do it:
```{r}
do_I_save_comp <- T
comp_path <- paste0(here(),"/Comparison_data/step2a_TF0q2_season/seq_2019_2022")
```
