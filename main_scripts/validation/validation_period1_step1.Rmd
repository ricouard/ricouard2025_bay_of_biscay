---
title: "ISIS-Fish MACCO - Validation mod 1, 2015-2018, forced recruitment"
...
This document contains the code along with the results of the skill assessment of step 1 model over the period 2015-2018. The simulations are run for four years, starting in 2015, with forced recruitment.
...
```{r}
sim_path <- paste0(here(),"/Sim_data/raw/step1_TF0q1/sim_valid_mod1_2015_2018_2025-07-08-23-22")
```

The path to tidy simulation data:
```{r}
sim_tidy_path <- paste0(here(),"/Sim_data/tidy/step1_TF0q1/seq_2015_2018")
```

Wether or not to save comparison datasets (obs vs. sim) and the path where to do it:
```{r}
do_I_save_comp <- T
comp_path <- paste0(here(),"/Comparison_data/step1_TF0q1/seq_2015_2018")
```
