...
Finally, the integrated analysis including computation of quality metrics for all species,  fleet and variables are performed by running the script `Validation_summary.Rmd`:
```
